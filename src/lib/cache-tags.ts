...
export const PUBLIC_PROJECT_SUGGESTIONS_TAG = "public-project-suggestions";
...
export function publicProjectSuggestionsTag(projectId: string) {
  return `public-project-suggestions:${projectId}`;
}
