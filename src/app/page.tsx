        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-20 sm:px-6 sm:py-28 lg:grid-cols-[1fr_0.75fr] lg:items-center lg:px-8">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full border bg-white/80 px-3 py-1.5 text-xs font-bold shadow-sm">
              <Sparkles className="size-3.5 text-primary" /> Built with AI.
              Shipped by humans.
            </span>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground sm:text-xl">
              A curated launchpad for independent AI products. Discover what
              builders are shipping, follow every iteration, and support the
              work you want to see win.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Button asChild size="lg" variant="accent">
                <Link href="/submit">
                  <Rocket className="size-4" /> Submit yours
                </Link>
              </Button>
            </div>
          </div>
          <div className="rounded-[2rem] border bg-foreground p-7 text-white shadow-[0_30px_90px_rgb(22_26_22/20%)] sm:p-9">
            ...
            <p className="mt-8 font-mono text-xs font-bold uppercase tracking-[0.18em] text-accent">
              The zihAI standard
            </p>
            <div className="mt-5 space-y-5">
              {[
                ...
                <div
                  key={number}
                  className="grid grid-cols-[2.5rem_1fr] gap-3 border-t border-white/15 pt-5"
                >
      ...
      >
        <div className="mb-7">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Recently approved by the zihAI review team.
          </p>
        </div>
